...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vuetify__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_ordenes_vue__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_visiometria_vue__ = __webpack_require__(79);
...
var _igmixin = __webpack_require__(24);

var _igmixin2 = _interopRequireDefault(_igmixin);

var _urls = __webpack_require__(25);
...
var _fab = __webpack_require__(84);
...
exports.default = {
    ...
    methods: {
            ...
            this.$http.get(_urls2.default.visiometria.concat(this.$route.params.id.toString() + '/')).then(function (response) {
                ...
                try {
                    for (var _iterator = (0, _getIterator3.default)(properties), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        ...
                        if (property in _this.visiometria) {
                            _this[property] = _this.visiometria[property];
                        }
                    }
                } catch (err) {
                    _didIteratorError = true;
                ...
                if (response.status == 403) {
                    _this.showSnackBar('No tienes permisos para estar en esta página.');
                } else {
                    _this.showSnackBar('Hubo un error al momento de guardar los datos, recargue la página e intentelo de nuevo');
                }
            });
        },
        ...
        submit: function submit() {
            ...
            var lentes_correctivos = this.lentes_correctivos,
                hace_cuanto = this.hace_cuanto,
            ...
            var method = 'id' in this.visiometria && this.visiometria.id ? 'put' : 'post';
            var url = _urls2.default.visiometria;
            if (method == 'put') {
                url += this.$route.params.id.toString() + '/';
            }

            data = (0, _assign2.default)(data, payload);

            this.$http[method](url, data, { headers: { 'X-CSRFToken': token.value } }).then(function (response) {
                _this2.visiometria = response.body;
                _this2.showSnackBar('Se ha guardado el resultado con exito');
            }, function (response) {
                if (response.status == 403) {
                    _this2.showSnackBar('No tienes permisos para realizar esta acción.');
                } else {
                    _this2.showSnackBar('Hubo un error al momento de guardar los datos, recargue la página e intentelo de nuevo');
                }
            });
        }
    }
...
var _errormixin = __webpack_require__(104);
